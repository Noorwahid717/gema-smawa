export const CODING_LAB_FILE_SIZE_LIMIT = 10 * 1024 * 1024 // 10 MB
export const CODING_LAB_TAG_LIMIT = 8
export const CODING_LAB_MAX_EDITOR_SIZE = 120_000
...
export function normalizeTags(value: unknown): string[] {
  ...
  return Array.from(new Set(sanitized)).slice(0, CODING_LAB_TAG_LIMIT)
}
