...
export async function POST(
  ...
  if (submission.draftArtifact === CodingLabArtifactType.EDITOR) {
  ...
  } else if (submission.draftArtifact === CodingLabArtifactType.UPLOAD) {
  ...
  const updated = await prisma.codingLabSubmission.update({
    ...
    data: {
      status: CodingLabSubmissionStatus.SUBMITTED,
